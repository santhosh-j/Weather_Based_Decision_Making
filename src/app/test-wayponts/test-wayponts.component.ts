...
@Component({
  selector: 'app-test-wayponts',
  templateUrl: './test-wayponts.component.html',
  styleUrls: ['./test-wayponts.component.css'],
  providers: [LambdaService]
})
export class TestWaypontsComponent implements OnInit {
...
weather : WeatherInfo =
{
  searchtype: "daily",
  searchtime: "5day",
  locationId: ["2132997","2274049","2233812","339583","343260"]
}
